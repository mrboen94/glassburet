...
export default function AlbumCard({
  ...
  return (
    <div className="flex flex-col">
      ...
      <button
        type="button"
        className="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mt-4 mx-10"
        onClick={handlePrint}
      >
        Print
      </button>

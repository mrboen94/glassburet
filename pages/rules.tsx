    ...
    <main>
      <div className="prose lg:prose-xl">
        ...
        <ul>
          ...
          <li>🛗 Heisanmerkning - Ved heisbruk.</li>
          <li>
            ☕ Søleanmerkning - Ved søling av farget væske i trappeoppgang.
          </li>
          <li>
        ...
        <h1> Del 4: Master skriving (TBD)</h1>
        <h3>§ 4.1 - Mengde</h3>
        <p>
          Fra og med 01.01.2022 vil det bli oppført anmerkning dersom man ikke
          har skrevet minimum 4 sider på sin masteroppgave i løpet av uken, hver
          uke. Disse anmerkningene kan ikke trenes inn og står til man opphever
          denne regelen.
        </p>
      </div>
    </main>
